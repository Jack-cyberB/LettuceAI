...
export const enMessages = {
  ...
  about: {
    ...
    community: {
      qqGroup: "QQ Community Group",
      groupNumber: "Group number",
      openHint: "Tap to open the QQ join page",
      copied: "QQ group number copied",
      copyFailed: "Couldn't copy the QQ group number",
    },
    developerMode: {
  ...
  components: {
    ...
    advancedModelSettings: {
      ...
      responseLengthDesc: "Limit each reply by an approximate Chinese character count",
      responseLengthAuto: "Auto",
      responseLengthShort: "80 chars",
      responseLengthMedium: "150 chars",
      responseLengthLong: "300 chars",
      responseLengthCustom: "Custom",
      responseLengthUnit: "Chinese characters max",
  ...
  chats: {
    ...
    settings: {
      ...
      importChatPackageTitle: "Import Chat Log",
      ...
      extractingImportedMemoryPreparing: "Preparing memory extraction...",
      extractingImportedMemoryWindow: "Processing batch {{current}}/{{total}}",
      extractingImportedMemoryStep: "Step {{current}}/{{total}}",
      importMemoryRunsInBackground:
        "You can close this window. Memory extraction will continue in the background and can be resumed from the memory page if interrupted.",
      ...
      calendarAwareness: "Festival Calendar",
      calendarAwarenessDesc:
        "Add enabled festivals and solar terms to this companion's time context.",
      calendarLookahead: "Calendar Range",
      calendarLookaheadDesc: "Choose a preset or enter a custom range from 1 to 90 days.",
      calendarDaysUnit: "days",
      calendarCustomDays: "Custom",
      calendarApplyCustomDays: "Apply custom calendar range",
      upcomingCalendarEvents: "Next {{count}} Days",
      upcomingCalendarEventsDesc: "Turn off a date to keep it hidden from the companion.",
      calendarEventsLoading: "Calculating calendar dates...",
      calendarEventsLoadFailed: "Failed to calculate calendar dates",
      noUpcomingCalendarEvents: "No calendar events in this range",
      calendarCategoryTraditional: "Traditional festival",
      calendarCategorySolarTerm: "Solar term",
      calendarCategoryWestern: "Western holiday",
      calendarEventDate: "{{date}} · {{weekday}}",
      ...
      calendarToday: "Today",
      calendarDaysUntil: "In {{count}} days",
      searchModels: "Search models...",
    ...
    history: {
      ...
      unarchive: "Unarchive",
      failedUnarchive: "Failed to unarchive: {{error}}",
      messagesCount: "{{count}} messages",
    ...
    companionMemoryPage: {
      ...
      relationship: "Relationship",
      processingMemories: "Processing memories...",
      importedMemoryTitle: "Imported memory initialization",
      importedMemoryRunning: "Running in the background",
      importedMemoryPaused: "Paused and ready to resume",
      importedMemoryFailed: "Paused after an error",
      importedMemoryResume: "Resume",
      importedMemoryProgress: "Batch {{current}}/{{total}}",
  ...
  characters: {
    ...
    description: {
      ...
      doubaoVoiceSettingsTitle: "Doubao voice parameters",
      resetVoiceSettings: "Reset",
      voicePitch: "Pitch",
      voiceSpeechRate: "Speed",
      ...
      voicePreviewError: "Preview failed",
    ...
    companionSetup: {
      ...
      modelsBody:
        "Companion now uses your configured chat model for emotion and memory work, so no extra local companion models are required.",
      modelsChecking: "Checking installed models...",
      modelsDoneTitle: "Companion is ready",
      explainIntro:
  ...
  providers: {
    ...
    audioEditor: {
      ...
      placeholders: {
        ...
        doubaoAccessKeyId: "Volcengine Access Key ID for ListSpeakers",
    ...
    list: {
      ...
      voiceManagementDescription: "Manage provider voices, voice libraries, and audio cache",
      responsesDialectArk: "Volcengine Ark",
    },
    ...
    editor: {
      ...
      imageUploadVolcengineFilesDesc:
        "Upload images first and send their file_id to the chat model",
      ...
      imageUploadProjectHint:
        "The Files API and chat endpoint must be able to access the same Ark project.",
      responsesDialect: "Responses compatibility",
      responsesDialectOpenAI: "Standard OpenAI",
      responsesDialectArk: "Volcengine Ark",
      responsesDialectOpenAIHint: "Use the standard OpenAI Responses request format.",
      responsesDialectArkHint:
        "Use Volcengine Ark thinking fields and Ark-compatible reasoning effort levels.",
      webSearchMode: "Web search tool",
      webSearchNone: "None",
      webSearchNoneDesc: "Do not expose a provider-native web search tool to the model.",
      webSearchVolcengineArk: "Volcengine Ark Web Search",
      webSearchVolcengineArkHint:
        "This plugin only works with supported Volcengine Ark models and must be enabled in the Ark console first.",
      ...
      streamUsage: "Stream Usage Reporting",
      streamUsageDesc: "Request token usage in the final chunk of streamed responses",
  ...
  editModel: {
    ...
    reasoning: {
      ...
      mode: "Thinking mode",
      modeDescription: "Choose how this model controls thinking for Responses requests.",
      modeAuto: "Auto",
      ...
      effortMax: "Maximum",
      modelSupportHint: "Available modes and effort levels still depend on the selected model.",
    ...
    webSearch: {
      ...
      description:
        "Allow this model to use the provider-native web search tool. This currently only applies to supported Volcengine Ark models.",
    },
    runtimeFacts: {
      updated: "Updated",
  ...
  systemPrompts: {
    builtInTemplates: {
      appDefault: "App Default",
      localRoleplayDefault: "Local RP Default",
      companionDefault: "Companion Default",
      dynamicMemorySummarizer: "Dynamic Memory: Summarizer",
      dynamicMemoryManager: "Dynamic Memory: Memory Manager",
      dynamicMemoryManagerLocal: "Dynamic Memory: Memory Manager (Local LLM)",
      ...
      lorebookGeneratorPlanner: "Lorebook Generator: Planner",
      lorebookGeneratorWriter: "Lorebook Generator: Writer",
      lorebookGeneratorRefine: "Lorebook Generator: Refine",
      lorebookGeneratorCoherence: "Lorebook Generator: Coherence",
      groupChatConversational: "Group Chat (Conversation)",
      groupChatRoleplay: "Group Chat (Roleplay)",
      avatarGeneration: "Avatar Generation",
      avatarEdit: "Avatar Image Edit",
      sceneGeneration: "Scene Generation",
      scenePromptWriter: "Scene Prompt Writer",
      designReferenceWriter: "Design Reference Writer",
      companionSoulWriter: "Companion Soul Writer",
      companionGrowthcycle: "Companion Growthcycle",
      companionConsolidation: "Companion Consolidation",
    },
    filters: {
      all: "All",
      system: "System",
  ...
  backup: {
    ...
    export: {
      ...
      fullSummary: "Back up all data and resources",
      customSettings: "Custom settings",
      estimating: "Estimating resource size...",
      estimateSummary: "About {{size}} · {{files}} resource files",
      selectedCharacters: "{{selected}} of {{total}} characters selected",
      selectAll: "Select all",
      clearAll: "Clear",
      coreData: "Character and chat data",
      audioResources: "Audio",
      imageResources: "Images",
      unassignedAudio: "Unassigned legacy TTS cache",
    },
    progress: {
      preparing: "Preparing backup data",
      data: "Writing character and chat data",
      resources: "Writing audio and image resources",
      finalizing: "Saving to Downloads",
      completed: "Backup complete",
      failed: "Backup failed",
      backgroundHint:
        "Closing this dialog will not stop the backup. Progress remains visible here.",
    },
    import: {
      replaceWarning: "This will replace all current data. Cannot be undone.",
      mergeWarning:
        "This custom backup updates its included characters and keeps other local data.",
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      embeddingV4Legacy: "v4 remains available and supports Matryoshka dimensions.",
      embeddingV4Latest: "v4 is the latest memory model and supports Matryoshka dimensions.",
      embeddingBgeSmallZhLatest: "bge-small-zh-v1.5 is the default Chinese memory model.",
      ...
      downloadBgeSmallZhDescription: "Chinese memory model powered by BAAI bge-small-zh-v1.5",
    },
    presets: {
      minimal: "minimal",
      balanced: "balanced",
  ...
  sessionAdvanced: {
    ...
    reasoning: {
      title: "Thinking mode",
      description: "Override the model's Responses thinking behavior for this conversation.",
      inherit: "Follow model",
      inheritedState: "Current model setting: {{state}}",
      providerDefault: "Provider default",
      auto: "Auto",
      enabled: "On",
      disabled: "Off",
      ...
      xhigh: "Very high",
      max: "Maximum",
      modelSupportHint: "Actual support depends on the selected model.",
    },
    webSearch: {
      title: "Web search",
      description:
  ...
  voices: {
    extra: {
      ...
      page: {
        ...
        loadProviderVoicesFailed: "Failed to load {{provider}} voices",
        refreshProviderVoicesFailed: "Failed to refresh {{provider}} voices",
        previewProviderVoiceFailed: "Failed to preview {{voice}}",
  ...
  usageAnalytics: {
    ...
    shared: {
      ...
      operations: {
        ...
        companionSoulWriter: "Soul Writer",
        sceneGeneration: "Scene Generation",
        lorebookGeneration: "Lorebook Generation",
